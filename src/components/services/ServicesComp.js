  ...
  return (
    <div data-section="services" className='container lg:h-[100vb] center flex-col overflow-hidden'>
        ...
        <div className='grid lg:grid-cols-3'>
            ...
            <div data-link="pricing" data-animate="services" className='relative left-[2000px] w-full center flex-col sm:gap-8 sm:px-10 px-4 py-16 rounded-xl hover:shadow-lg hover:shadow-mainColor/30 hover:border-b-mainColor border-b-transparent border-b-4 hover:scale-105 hover:cursor-pointer'>
